...
import { UndoManager } from "../src/internals.js";
...
export const testUndoXml = (tc) => {
  ...
  t.assert(
    xml0.toString() === "<undefined><p>con<bold>tent</bold></p></undefined>"
  );
  undoManager.undo();
  t.assert(xml0.toString() === "<undefined><p>content</p></undefined>");
  undoManager.redo();
