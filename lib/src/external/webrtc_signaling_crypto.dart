...
//  */
// Future<CryptoKey> deriveKey = (secret, roomName) => {
...
//  */
// Future<Uint8List>  encrypt (Uint8List data,CryptoKey? key){
//   if (!key) {
//     return /** @type {PromiseLike<Uint8Array>} */ (Future.value(data));
//   }
...
//  */
// Future<Uint8List> encryptJson  (Object data, CryptoKey? key) {
...
//  */
// Future<Uint8List> decrypt (Uint8List data, CryptoKey? key)  {
//   if (!key) {
//     return /** @type {PromiseLike<Uint8Array>} */ (Future.value(data));
//   }
...
//  */
// Future<Object> decryptJson(Uint8List data,CryptoKey? key) =>
